...
resource "azurerm_subnet" "runtime" {
  ...
  resource_group_name  = azurerm_resource_group.main.name
  virtual_network_name = azurerm_virtual_network.main.name
  address_prefixes     = var.runtime_subnet_prefix
}

# NSG for Management Subnet
resource "azurerm_network_security_group" "management" {
  name                = "nsg-${var.management_subnet_name}"
  location            = azurerm_resource_group.main.location
  resource_group_name = azurerm_resource_group.main.name
  tags                = var.tags
...
# NSG for Runtime Subnet
resource "azurerm_network_security_group" "runtime" {
  name                = "nsg-${var.runtime_subnet_name}"
  location            = azurerm_resource_group.main.location
  resource_group_name = azurerm_resource_group.main.name
  tags                = var.tags
...
# Associate NSG with Runtime Subnet
